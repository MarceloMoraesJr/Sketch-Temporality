...
class LtQuickDraw(pl.LightningDataModule):
    def __init__(self, dataset_path, loader_args):
        super().__init__()
        self.dataset_path = dataset_path
        self.loader_args = loader_args

    def setup(self, stage=None):
        self.train_dataset = QuickDrawDataset(self.dataset_path, split='train')
        self.val_dataset = QuickDrawDataset(self.dataset_path, split='valid')
        self.test_dataset = QuickDrawDataset(self.dataset_path, split='test')
