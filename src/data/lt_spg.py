...
class LtSPG(pl.LightningDataModule):
    ...
    def setup(self, stage=None):
        self.train_dataset = SPGDataset(self.dataset_path, split=f'train-{self.split}', perturbations=self.perturbations)
        self.val_dataset = SPGDataset(self.dataset_path, split=f'valid-{self.split}', perturbations=self.perturbations)
        self.test_dataset = SPGDataset(self.dataset_path, split=f'test-{self.split}', perturbations=self.perturbations)
